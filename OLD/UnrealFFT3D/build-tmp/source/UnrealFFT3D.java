...
public class UnrealFFT3D extends PApplet {
		...
		if(mode_3D){
			...
			//for(int j = 0; j< history_band_size-1;j++){
				...
				if(figure_3d==0){
					...
					translate(bar_x_3,500+history_band_values[history_j][i]/2,0);
				}
...
public void keyboard(long now){
	...
	if (keyPressed){
		switch (key){
			...
			case 'l': rotate_y-= 0.1f;break;
			case 'j': rotate_y+= 0.1f;break;
			case 'i': rotate_x-=0.1f;break;
			case 'k': rotate_x+=0.1f;break;
			case 'u': rotate_z-=0.1f;break;
			case 'o': rotate_z+=0.1f;break;
			...
			case 'f': if(key_release == 1){ if(mode_background == 1) mode_background = 0; else mode_background++; key_release = 0;} break;
...
public void stop()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "UnrealFFT3D" };
    if (passedArgs != null) {
